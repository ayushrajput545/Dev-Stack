    ...
    <> 
    {
     projectData &&
       projectData.map((items,i)=>{
        ...
        return(
           <div onClick={()=>navigate('/editor')} className={`w-[270px] h-[200px] bg-[#141414] rounded-lg hover:bg-[#202020] flex flex-wrap p-[10px] ${theme ? 'bg-gray-200 hover:bg-gray-300' :'bg-[#141414] hover:bg-[#202020]'}`}>
      ...
      <div className={`flex flex-col gap-2 items-center justify-center w-[270px] h-[200px] my-5 md:text-3xl text-xl font-bold p-[20px]   ${theme ? 'bg-gray-200 hover:bg-gray-300' :'bg-[#141414] hover:bg-[#202020]'}`}>
