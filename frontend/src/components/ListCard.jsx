...
const ListCard = ({projectData ,theme,setCreateProject}) => {
  ...
  return (
    <>
        ...
        return (
          <div className={`flex items-center justify-between w-full my-5 p-[20px]  ${theme ? 'bg-gray-200 hover:bg-gray-300' :'bg-[#141414] hover:bg-[#202020]'}`}>
         ...
         <div>
           <MdDeleteForever onClick={()=>{setDeletion(true); setDeleteId(items._id)}} className='text-4xl text-red-400 hover:cursor-pointer'/>
         </div>
        ...
        <div className={`flex flex-col gap-2 items-center justify-center w-full my-5 md:text-3xl text-xl font-bold p-[20px]   ${theme ? 'bg-gray-200 hover:bg-gray-300' :'bg-[#141414] hover:bg-[#202020]'}`}>
